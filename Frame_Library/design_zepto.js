...
var Zepto = (function() {
	...
	*/
	zepto.matches = function(element, selector) {
		...
		/*
		matchesSelector用来匹配dom元素是否匹配某css selector。它为一些高级方法的实现提供了基础支持
		*/
		var matchesSelector = element.webkitMatchesSelector || element.mozMatchesSelector || element.oMatchesSelector || element.matchesSelector
		/*
		如果支持matchesSelector原生选择器，则调用原生选择器
		*/
		if (matchesSelector){
			return matchesSelector.call(element, selector);
		}
		/*
		否则的话，创建临时节点并将需查找的元素放入节点中，通过父节点查找子节点的方法并做相关过滤返回布尔值
		*/
  ...
  */
  ...
  /*
  选择器类型判断,主要有id类型、class类型，tag类型，通配类型，以及未匹配的空类型
  */
