(function ($) {
    $(function () {
        ...
        jQuery.validator.addMethod("ischi_phone", function (value, element) {
            var phonecode = /^0?(13[0-9]|14[579]|15[012356789]|16[6]|17[01235678]|18[0-9]|19[89])[0-9]{8}$/;
        ...
        popup_validcode.click(function () {
            var phonerule = /^0?(13[0-9]|14[579]|15[012356789]|16[6]|17[01235678]|18[0-9]|19[89])[0-9]{8}$/, phonevalue = document.getElementById("mobilephone").value;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    MobilePhone: function () {
                        return document.getElementById("mobilephone").value;
                    }
                },
                dataType: 'json',
