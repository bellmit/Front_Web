angular.module('app')
    .service('equipmentService',['toolUtil','toolDialog','BASE_CONFIG','loginService','powerService','dataTableColumnService','datePicker97Service',function(toolUtil,toolDialog,BASE_CONFIG,loginService,powerService,dataTableColumnService,datePicker97Service){
                                        ...
                                        if(len===0){
                                            ...
                                            for(i;i<len;i++){
                                                if(j===1){
                                                    ...
                                                    str+='<td><label data-id="'+list[i]["id"]+'"><input name="goods" data-id="'+list[i]["id"]+'" type="radio" />'+list[i]["deviceImei"]+'</label></td>';
                                                }
                                                j++;
                                            }
                                            if(str!==''){
