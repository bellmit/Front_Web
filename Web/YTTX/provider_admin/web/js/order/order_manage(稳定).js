...
(function($){
	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			var ordermanage_page={
				...
				ordermanage_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:/*"../../json/goods/goods_list.json"*/"http://120.24.226.70:8082/yttx-providerbms-api/goodsorder/list",
							dataType:'JSON',
							method:'post',
			...
			/*查询物流公司*/
			$.ajax({
					url:"http://120.24.226.70:8082/yttx-providerbms-api/shipping/express/list",
					method: 'POST',
					dataType: 'json',
					data:{
						shippingMethodId:1,
						...
						$.extend(true,(function () {
							...
							submitHandler: function(form){
								...
								if(formtype==='ordersend'){
									...
									config['url']="http://120.24.226.70:8082/yttx-providerbms-api/order/tracking/add";
									config['data']=setdata;
								}
