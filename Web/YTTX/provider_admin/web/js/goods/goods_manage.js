		...
		if(public_tool.initMap.isrender){
			...
			var goodsmanage_page={
				...
				goodsmanage_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:/*"../../json/goods/goods_list.json"*/"http://120.24.226.70:8082/yttx-providerbms-api/goods/list",
							dataType:'JSON',
							method:'post',
			...
			$goods_manage_wrap.delegate('span','click',function(e){
				...
				if(action==='update'){
					...
					/*上架和下架*/
					$.ajax({
							url:"http://120.24.226.70:8082/yttx-providerbms-api/goods/status/update",
							method: 'POST',
							dataType: 'json',
							data:{
								ids:id,
