...
(function($){
	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			/*数据加载*/
			var agent_config={
				url:"http://120.24.226.70:8082/yttx-agentbms-api/agents/related",
				dataType:'JSON',
				method:'post',
			...
			$agent_list_wrap.delegate('span','click',function(e){
				...
				if(action==='delete'){
					...
					/*查看*/
					$.ajax({
							url:"http://120.24.226.70:8082/yttx-agentbms-api/agent/view",
							method: 'POST',
							dataType: 'json',
							data:{
								"agentId":id,
					...
					/*绑定代理商请求数据*/
					$.when($.ajax({
						url:"http://120.24.226.70:8082/yttx-agentbms-api/servicestation/notbound/list",
						method: 'POST',
						dataType: 'json',
						data:{
							"roleId":decodeURIComponent(logininfo.param.roleId),
						...
						url:"http://120.24.226.70:8082/yttx-agentbms-api/servicestation/bound/list",
						method: 'POST',
						dataType: 'json',
						data:{
							"agentId":id,
			...
			$.each([$service_bindbtn,$service_unbindbtn], function () {
				...
				this.on('click', function () {
					...
					var $this=$(this),
						...
						config={
							url:"http://120.24.226.70:8082/yttx-agentbms-api/servicestation/binding/operation",
							dataType:'JSON',
							method:'post',
							data:{
