...
(function($){
	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			/*数据加载*/
			var agent_config={
				url:"http://120.24.226.70:8082/yttx-agentbms-api/logistics/receivings",
				dataType:'JSON',
				method:'post',
				...
				url:"http://120.24.226.70:8082/yttx-agentbms-api/logistics/receiving/view",
				dataType:'JSON',
				method:'post',
				dataSrc:function ( json ) {
					var code=parseInt(json.code,10);
			...
			$edit_sure_btn.on('click',function(){
				...
				$.ajax({
						url:"http://120.24.226.70:8082/yttx-agentbms-api/logistics/confirmreceipt",
						dataType:'JSON',
						method:'post',
						data:{
							receiptType:searchtype,
				...
				if(formcache.form_opt_0){
					$.extend(true,form_opt,formcache.form_opt_0,{
						submitHandler: function(form){
							...
							/*更新*/
							var config={
								url:"http://120.24.226.70:8082/yttx-agentbms-api/logistics/confirmexception",
								dataType:'JSON',
								method:'post',
								data:{
									roleId:decodeURIComponent(logininfo.param.roleId),
