	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			public_tool.loadSideMenu(public_vars.$mainmenu,public_vars.$main_menu_wrap,{
				url:'http://120.24.226.70:8082/yttx-agentbms-api/module/menu',
				async:false,
				type:'post',
				param:{
					roleId:roleid,
			...
			table=$admin_role_wrap.DataTable({
				...
				ajax:{
					url:"http://120.24.226.70:8082/yttx-agentbms-api/roles",
					dataType:'JSON',
					method:'post',
					dataSrc:function ( json ) {
						var code=parseInt(json.code,10);
						...
						if(action==='delete'){
							setSure.sure('delete',function(cf){
								...
								if(isrole){
									//删除角色
									config={
										url:"http://120.24.226.70:8082/yttx-agentbms-api/role/delete",
										method: 'POST',
										dataType: 'json',
										data:{
											"roleId":id,
									...
									//删除成员
									config={
										url:"http://120.24.226.70:8082/yttx-agentbms-api/sysuser/delete",
										method: 'POST',
										dataType: 'json',
										data:{
											"userId":id,
								...
								$.ajax(config)
									...
									.fail(function(resp){
										...
										cf.dia.content('<span class="g-c-bs-warning g-btips-warn">'+(resp.message||"删除失败")+'</span>').show();
										setTimeout(function () {
											cf.dia.close();
										},2000);
									});
							...
							if(isrole){
								...
								if(member_config.url===''){
									member_config.url='http://120.24.226.70:8082/yttx-agentbms-api/sysusers';
								}
								...
								/*查看详情*/
								$.ajax({
										url:"http://120.24.226.70:8082/yttx-agentbms-api/sysuser/info",
										dataType:'JSON',
										method:'post',
										data:{
											"userId":id,
					...
					$.extend(true,form_opt_0,public_tool.cache.form_opt_0,{
						submitHandler: function(form){
							...
							if(id!==''){
								//修改角色
								var config={
											url:"http://120.24.226.70:8082/yttx-agentbms-api/role/update",
											method: 'POST',
											dataType: 'json',
											data:{
												"roleId":id,
								...
								//添加角色
								var config={
									url:"http://120.24.226.70:8082/yttx-agentbms-api/role/add",
									method: 'POST',
									dataType: 'json',
									data:{
										"roleId":decodeURIComponent(logininfo.param.roleId),
					...
					$.extend(true,form_opt_1,public_tool.cache.form_opt_1,{
						submitHandler: function(form){
							...
							if(id!==''){
								//修改成员
								var config={
									url:"http://120.24.226.70:8082/yttx-agentbms-api/sysuser/update",
									method: 'POST',
									dataType: 'json',
									data:{
										"userId":id,
								...
								//添加成员
								var config={
									url:"http://120.24.226.70:8082/yttx-agentbms-api/sysuser/add",
									method: 'POST',
									dataType: 'json',
									data:{
