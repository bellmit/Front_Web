(function($){
	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			var order_page={
				...
				order_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:"http://120.24.226.70:8082/mall-agentbms-api/goodsorder/list",
							dataType:'JSON',
							method:'post',
			...
			/*查询物流公司*/
			$.ajax({
					url:"http://120.24.226.70:8082/mall-agentbms-api/shipping/express/list",
					method: 'POST',
					dataType: 'json',
					data:{
						shippingMethodId:1,
				...
				if(action==='send'&&id!==''){
					...
					(function () {
						...
						if(subclass){
							...
							if(subitem===''){
								$.ajax({
										url:"http://120.24.226.70:8082/mall-agentbms-api/goodsorder/details",
										dataType:'JSON',
										method:'post',
										data:{
											id:id,
							...
							submitHandler: function(form){
								setSure.sure('发货',function(cf){
									...
									if(formtype==='ordersend'){
										...
										config['url']="http://120.24.226.70:8082/mall-agentbms-api/order/tracking/add";
										config['data']=setdata;
									}
