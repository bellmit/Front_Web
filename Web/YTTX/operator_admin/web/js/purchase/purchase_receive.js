...
(function($){
	...
	$(function(){
						...
						$.extend(true,(function () {
							...
							submitHandler: function(form){
								...
								if(formtype==='storereceive'){
									...
									config['url']="http://120.24.226.70:8082/mall-agentbms-api/purchasing/orderaudited/delivered";
									config['data']=setdata;
		...
		function setReceiveData(id) {
			...
			$.ajax({
					url:"http://120.24.226.70:8082/mall-agentbms-api/purchasing/orderaudited/view",
					dataType:'JSON',
					method:'post',
					data:{
						"id":id,
