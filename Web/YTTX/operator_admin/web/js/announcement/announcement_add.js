...
(function($,KE){
	...
	$(function(){
							...
							submitHandler: function(form){
								...
								if(formtype==='addannouncement'){
                                    ...
                                    if(id!==''){
                                        ...
                                        setdata['id']=id;
										actiontype='修改';
										config['url']="http://120.24.226.70:8082/mall-agentbms-api/announcement/update";
                                    }else{
										/*新增操作*/
										config['url']="http://120.24.226.70:8082/mall-agentbms-api/announcement/add";
										actiontype='新增';
                                        delete setdata['id'];
                                    }
									config['data']=setdata;
		...
		function getToken(){
			var result=null;
			$.ajax({
				url:'http://120.24.226.70:8082/mall-agentbms-api/qiniu/token/get',
				async:false,
				type:'post',
				datatype:'json',
				data:{
