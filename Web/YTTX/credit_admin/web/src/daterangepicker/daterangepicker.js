                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      '<label class="g-d-hidei" for="daterangepicker_start"></label>' +
                      '<input class="input-mini g-d-hidei" type="text" name="daterangepicker_start" value="" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label class="g-d-hidei" for="daterangepicker_end"></label>' +
