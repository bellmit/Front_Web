...
(function ($) {
    ...
    //清除本地存储
    public_tool.clearAll = function (flag) {
        if (this.supportStorage) {
            if (flag) {
    ...
    /*去除表单常用非法字符*/
    public_tool.trimHtmlIllegal = function (str) {
        var tempstr = str.replace(/["'\/！￥…（）——《》？：“”，。；：’‘、【】]/ig, '');
        return tempstr.replace(/(&#34;|&quot;|&#60;|&lt;|&#62;|&gt;|&#160;|&#180;|&acute;)/ig, '');
    };
    /*去除所有非法字符*/
    public_tool.trimIllegal = function (str) {
    ...
    /*是否是合法手机号*/
    public_tool.isTelePhone = function (str, type) {
        /*/(\d{4})(\d{8})/*/
