...
(function () {
    ...
    /*定义指令*/
    angular
        .module('ui.common', [])/*公共指令集名称*/
        .directive('uiHeaderMenu', uiHeaderMenu)/*头部导航栏指令*/
        .directive('uiHeaderLogout', uiHeaderLogout)/*头部退出*/
        .directive('uiSubLogo', uiSubLogo)/*首页logo指令*/
        .directive('uiSubInfo', uiSubInfo)/*首页用户信息指令*/
        .directive('uiSubList', uiSubList)/*列表指令*/
        .directive('uiSubSearch', uiSubSearch)/*侧边栏搜索指令*/
        .directive('uiSubTabHref', uiSubTabHref)/*侧边栏tab选项卡跳转指令*/
        .directive('uiSubTab', uiSubTab)/*侧边栏tab选项卡指令*/
        .directive('uiSubMenu', uiSubMenu)/*侧边栏级联菜单指令*/
        .directive('uiSubBtn', uiSubBtn)/*侧边栏按钮指令*/
        .directive('uiMainApp', uiMainApp)/*首页快捷方式指令*/
        .directive('uiLoadingAnimation', uiLoadingAnimation)/*加载动画指令*/
        .directive('uiSupportPanel', uiSupportPanel)/*兼容性提示*/
