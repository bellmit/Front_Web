...
(function () {
    ...
    /*控制注入依赖*/
    providerGoodsController.$inject = ['toolUtil', 'assistCommon', 'pageService', 'dataTableService', 'providerService', 'providerGoodsService', 'testService'];


    /*控制器实现*/
    function providerGoodsController(toolUtil, assistCommon, pageService, dataTableService, providerService, providerGoodsService, testService) {
        var vm = this,
            debug = true/*测试模式*/;
        ...
        function getTableData() {
            providerGoodsService.getTableData({
                table: vm.table,
                record: vm.record,
                index: 1
            });
