							...
							submitHandler: function(form){
								...
								if(formtype==='addsalesman'){
                                    ...
                                    if(id!==''){
                                        ...
                                        setdata['id']=id;
										actiontype='修改';
										config['url']="http://120.76.237.100:8081/mall-agentbms-api/salesman/update";
                                    }else{
										/*新增操作*/
										actiontype='新增';
                                        delete setdata['id'];
										config['url']="http://120.76.237.100:8081/mall-agentbms-api/salesman/add";
                                    }
									config['data']=setdata;
								}
