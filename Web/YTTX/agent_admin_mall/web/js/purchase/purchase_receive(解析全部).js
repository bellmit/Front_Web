...
(function($){
	...
	$(function(){
						...
						$.extend(true,(function () {
							...
							submitHandler: function(form){
								...
								if(formtype==='storereceive'){
									...
									config['url']="http://10.0.5.222:8080/mall-agentbms-api/purchasing/orderaudited/delivered";
									config['data']=setdata;
		...
		function setReceiveData(id) {
			...
			$.ajax({
					url:"http://10.0.5.222:8080/mall-agentbms-api/purchasing/orderaudited/view",
					dataType:'JSON',
					method:'post',
					data:{
						"id":id,
