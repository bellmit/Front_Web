			...
			var purchase_page={
				...
				purchase_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:"http://10.0.5.222:8080/mall-agentbms-api/purchasing/order/list"/*"../../json/purchase/mall_purchase_stats_list.json"*/,
							dataType:'JSON',
							method:'post',
				...
				if(action==='receive'){
					...
					(function () {
						...
						if(subclass){
							...
							if(subitem===''){
								$.ajax({
										url:"http://10.0.5.222:8080/mall-agentbms-api/purchasing/order/details"/*"../../json/purchase/mall_purchase_stats_details.json"*/,
										dataType:'JSON',
										method:'post',
										data:{
											id:id,
