...
function generateRule(str) {
  ...
  if (typeof str === 'undefined') {
    ...
    if (str === 'id') {
      ...
      return _Random_.province();
    } else if (str === 'city') {
      return _Random_.city();
    } else if (str === 'country') {
      return _Random_.county();
    } else if (str === 'address') {
      return _Random_.county(true);
...
function generateMap(config) {
  ...
  for (var i in map) {
    switch (map[i]) {
      ...
      case 'province':
        (function () {
          var address = _Random_.county(true).split(' ');
          map_obj[i] = address[0];
          /*存在市*/
          if (map['city']) {
        ...
        break;
      case 'address':
        map_obj[i] = _Random_.county(true);
        break;
      case '':
        map_obj[i] = '';
        break;
...
export const testWidget = new TestApi();
