		...
		if(public_tool.initMap.isrender){
			...
			if($.isFunction($.fn.validate)) {
				...
				/*if(public_tool.cache.form_opt_0){
					$.extend(true,form_opt1,public_tool.cache.form_opt_0,{
						submitHandler: function(form){
							var ele_a=$profit_a1.val(),
								ele_aa=$profit_aa1.val(),
								ele_aaa=$profit_aaa1.val(),
			...
			/*绑定限制*/
			$.each([$profit_a0,$profit_aa0,$profit_aaa0,$profit_a1,$profit_aa1,$profit_aaa1,$profit_a2,$profit_aa2,$profit_aaa2],function(){
